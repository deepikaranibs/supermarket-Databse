...
$dbh=mysqli_connect("localhost","root","",'supermarket');
 if(isset($_POST['username'])){
	 ...
	 if(mysqli_num_rows($result)==1)
	 {
		 ...
		 echo "<h2 align='center' bgcolor='lime'>SUCCESSFULL LOGIN !!!!";
		 echo "<br><br>";
		  echo "<a href='index1.html'>CLICK HERE TO VIEW DETAILS</a></h2>";
	 ...
	 else
	 {
		 ...
		 echo "<br><br>";
		 echo "<a href = 'index.php'> CLICK HERE TO GO BACK</a><h2>";
		 exit();
	 }
 }
 ?>
